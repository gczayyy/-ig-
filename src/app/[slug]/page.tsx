    ...
    <>
      <article>
        ...
        <section className="bg-brand-dark text-white py-12 sm:py-16">
          <div className="mx-auto max-w-3xl px-4">
            <a href="/" className="inline-flex items-center gap-1.5 text-xs text-white/60 hover:text-red-light transition mb-4">
      ...
      <section className="border-t border-black/5 py-10">
        <div className="mx-auto max-w-3xl px-4 text-center">
          <p className="text-sm text-muted mb-3">關注茜帆，獲取更多內容</p>
